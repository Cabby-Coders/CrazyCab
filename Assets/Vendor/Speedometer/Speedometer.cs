...
public class Speedometer : MonoBehaviour {
	...
	*/
	...
	void OnGUI() {
		...
		speedometer_main_rect = new Rect(Screen.width - speedometer_main_size, 0, speedometer_main_size, speedometer_main_size);
		speedometer_needle_rect = new Rect(Screen.width - (speedometer_main_size / 2) - (speedometer_needle_sizeX / 2),
		                                   (speedometer_main_size / 2) - (speedometer_needle_sizeY),
		...
		if(isKph == true) {
			...
			speed = rigidBody.velocity.magnitude * 2.237f;
